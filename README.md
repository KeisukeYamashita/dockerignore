...
This is GitHub’s collection of [`.dockerignore`][man] file templates.
We use this list to populate the `.dockerignore` template choosers available
in the GitHub.com interface when creating new repositories and files.

For more information about how `.dockerignore` files work, and how to use them,
...
- [`Global`](./Global) contains templates for various editors, tools and
  ...
  that you either [add these to your global template](https://help.github.com/articles/ignoring-files/#create-a-global-dockerignore)
...
A template should contain a set of rules to help Git repositories with Docker work with a
...
For example, this template might live at `community/DotNet/InforCRM.dockerignore`:

```
# dockerignore template for InforCRM (formerly SalesLogix)
# website: https://www.infor.com/product-summary/cx/infor-crm/
#
# Recommended: VisualStudio.dockerignore
